...
{
    public class clsBaseForm : Form , IThemeable
    {
        public void ShowDialogIfAuthorized(byte? FormAccess, Form frm)
        {
        ...
        public HashSet<Control> GetAllFormControls(Control frm)
        {
        ...
        public void SetTheme(Control frm)
        {
            HashSet<Control> controls = GetAllFormControls(frm);
            SetTheme(controls);
        }
